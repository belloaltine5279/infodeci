...
empty definition using pc, found symbol in pc: withColumn.
empty definition using semanticdb
|empty definition using fallback
non-local guesses:
	 -org/apache/spark/sql/types/categories/withColumn.
	 -org/apache/spark/sql/types/categories/withColumn#
	 -org/apache/spark/sql/types/categories/withColumn().
	 -org/apache/spark/sql/functions/categories/withColumn.
	 -org/apache/spark/sql/functions/categories/withColumn#
	 -org/apache/spark/sql/functions/categories/withColumn().
	 -categories/withColumn.
	 -categories/withColumn#
	 -categories/withColumn().
	 -scala/Predef.categories.withColumn.
	 -scala/Predef.categories.withColumn#
	 -scala/Predef.categories.withColumn().
...
val usersTable = users
  ...
  .withColumn("mot", trim(lower(col("mot")))) // Utilisation de lower() avec trim

val occurences = mots
  .groupBy("mot")
  .count()

val motsRepetitifs = occurences.filter("count" >= 10)
motsRepetitifs.show(truncate = false)
